    ...
    >
      ...
      <div style={{ marginBottom: "30px" }}>
        ...
        <p
          ...
          style={{ color: "#888", marginTop: "5px", fontSize: "1.1rem" }}
        >
        ...
        >
          ...
          >
            <button
              ...
              className={`btn-aba ${abaRapida === "tudo" ? "ativo" : ""}`}
            >
              TUDO
            </button>
            <button
              onClick={() => setAbaRapida("hoje")}
              className={`btn-aba ${abaRapida === "hoje" ? "ativo" : ""}`}
            >
              🔥 HOJE
            </button>
            <button
              onClick={() => setAbaRapida("populares")}
              className={`btn-aba ${abaRapida === "populares" ? "ativo" : ""}`}
            >
              💥 EM ALTA
            </button>
          </div>
              ...
              >
                ...
                >
                  <div
                    style={{
                      background:
                        evento.valorExibicao === 0 ? "#00ff00" : "#111",
                      color: evento.valorExibicao === 0 ? "#000" : "#00ff00",
                      padding: "4px 8px",
                      borderRadius: "4px",
                      fontFamily: "monospace",
                      fontWeight: "bold",
                  ...
                  <div
                    className="fonte-quadrada"
                    style={{ color: "#ff003c", fontSize: "1.2rem" }}
                  >
