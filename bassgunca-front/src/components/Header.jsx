...
function Header({
  ...
  // --- A FECHADURA BLINDADA DO PRODUTOR ---
  ...
  return (
    ...
    >
      <div className="user-info" style={{ transition: "all 0.3s" }}>
        ...
        >
          SALVE,{" "}
          {(usuarioLogado?.vulgo || usuarioLogado?.nome || "").toUpperCase()}!
        </h1>
        <p
          style={{
            fontSize: "0.9rem",
        ...
        >
          ...
          <span style={{ color: "#fff" }}>
            {usuarioLogado?.funcoes || usuarioLogado?.funcao || "Sem função"}
          </span>
        </p>
      </div>
      ...
      <div style={{ display: "flex", alignItems: "center", gap: "30px" }}>
        ...
        <button
          ...
          style={{
            ...
            animation: naoLidas > 0 ? "balancar 2s infinite" : "none",
          }}
          title="Notificações"
        ...
        {/* BOTÃO DE NOVO EVENTO (AGORA BLINDADO) */}
        {ehProdutor && (
          <button
